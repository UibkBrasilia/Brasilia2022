const GRUPPE3 = [
    ...
    {
        nr: 3,
        user: "Verticalization in the form of high-rise buildings",
    ...
    {
        nr: 4,
        user: "Housekeepers (empregada) and cleaning people (diaristas) in Águas Claras",
    ...
    {
        nr: 5,
        user: "Basic functions of existence in Águas Claras",
    ...
    {
        nr: 6,
        user: "Distribution of gastronomy",
    ...
    {
        nr: 7,
        user: "Heatmaps of grocery shopping",
    ...
    {
        nr: 8,
        user: "Heatmaps of different services",
    ...
    {
        nr: 10,
        user: "Eating out (restaurants, cafés etc.)",
    ...
    {
        nr: 11,
        user: "Buying everyday groceries in Águas Claras",
    ...
    {
        nr: 12,
        user: "Medical facilities and insurance",
    ...
    {
        nr: 13,
        user: "Distance to everyday supply facilities",
    ...
    {
        nr: 14,
        user: "Distance to medical facilities",
    ...
    {
        nr: 15,
        user: "Satisfaction of the everyday supply in Águas Claras",
    ...
    {
        nr: 16,
        user: "Satisfaction of the medical supply in Águas Claras",
