const GRUPPE2 = [
    {
        ...
        Adresse: "",
        intro: "Attractive free time only for the priviledged?",
        about: " The Parque da Cidade offers extensive green and blue spaces and thus plays an important role in the recreational use of the population. With its 420 ha, the city park offers space for various sports activities, barbecue areas, playgrounds for children, a lake and much more. This makes it a popular meeting place among all age groups but unfortunately not all income groups. Since the park is located in the middle of the plano piloto and people coming from the satellite cities barely find their way to the center for leisure time, because there is too much time spent on the way to get there. On the other hand, people from the Plano Piloto take advantage of the location as it is both the perfect spot for after-work activities during the week and a place to linger on weekends.",
    ...
    {
        nr: 4,
        user: "Prohibition sign at a park",
        Adresse: "Adresse",
        intro: "Leisure activities and protected areas",
        about: "The sign at the entry of a park, which says that it is a nature reserve, prohibits diverse activities. This shows that the will to preserve nature is also in direct contact to the use of the park by ist visitors. This is why the assumption, that territorial protection i.e. the protection of nature might have an impact on the use of free spaces during leisure activities might be true. Though it is important to know, that there are many different types of protected areas in Distrito Federal.",
        weblink: "Weiterführender Link",
        image: "<img src='prohibition_sign.jpeg' />", 
        lat:  -15.836528, 
        lng: -47.866270,
    },
  {
        nr: 5,
        user: " Morro da Asa Delta",
        Adresse: "Adresse",
        intro: "Appropriation of public space",
        about: "At the Morro da Asa Delta park, there was a specific conflict of appropriation. Due to the rich residential area, surrounding the Lago Paranoá, it was also the upper class population who was partially trying to appropriate public space next to their parcells to get direct and private access to the lake. This is not only an illegal action, it is also threatens the democratic access to the lake as well as its use during leisure activities for people who are living outside the bordering quarters. Furthermore, it underlines the process and the degree of segregation in Brasília.",
        weblink: "Weiterführender Link",
        image: "<img src='church.jpeg' />", 
        lat:   -15.837380, 
        lng: -47.864474,
    },
{
        ...
        user: " Lago Paranoá",
        Adresse: "Adresse",
        intro: "Unequal access to public blue space",
        ...
        weblink: "Weiterführender Link",
        image: "<img src='lago_paranoa.jpeg' />", 
        lat:   -15.791370, 
        lng: -47.815645,
    },
{
    ...
    },
{
        ...
        Adresse: "Adresse",
        intro: "  ",
        about: "The Estação Ecológica de Águas Emendadas is one of the three most important areas for natural protection in Brasilia, next to national park and the botanical garden, which stand under high ecological pressure. It covers an area of 10,547 ha and is home to ecosystems of great ecological importance. It forms the junction of the two largest South American river basins, the Amazon and the Platina, which connect in a common source in a 6 km long path. It is also of great importance for the conservation of the landscape, habitats and biocenosis of the Cerrado. Several government agencies and scientific institutions at national and international level conduct research in the station. Due to the construction of residential areas and urban settlements in its vicinity, the anthropogenic pressure on the Águas Emendadas is enormous. In its surroundings there are large cultivated areas whose agricultural techniques attack the environment, expose the soil and cause erosion. ",
        weblink: "Weiterführender Link",
        image: "<img src='aguasemendadas.jpeg' />", 
...
},
{
        ...
        Adresse: "Adresse",
        intro: "  ",
        about: " The Parque Ecológico do Cortado is a green area located in the satellite city called Taguatinga.  It can be taken as the perfect example for superficial sustainability in ecological parks in Brasilia. In the course of an Photointerview, one student of the University of Brasilia sent us a picture of a littered waterfall surrounding that shows the lack of maintencance in these areas. Furthermore he mentioned, that the security aspect also needs improvement, since cases of rubbery, assault and abuse happen due to a lack of securities. In addition he told us, as a result of the bad maintainance of these green and blue spaces, tropical diseases can develop and spread more easily. An example referring to this is the dengue mosquito, which creates its habitat in stagnant water areas with tropical climate conditions and spreads dengue fever, which is already a problem in Brasilia.  ",
        weblink: "Weiterführender Link",
        image: "<img src='trash.jpeg' />", 
...

{
        ...
        Adresse: "Adresse",
        intro: "",
        about: " The national park is located in the northwest of the Distrito Federals. The main objective of the park is to preserve an important section of the Cerrado biome and the water quality of the Santa Maria reservoir, which provides 25 percent of Brasilia's drinking water supply, and the Torto and Bananal rivers, which contribute to Lake Paranoá. For the local population, it is a popular place for recreation. The main attractions are the natural pools fed by water from the headwaters in the park. The park charges an entrance fee and is not as centrally located as, for example, Parque da Cidade. Therefore, most people visit it mainly on weekends when there is enough time. Because of the cost, not everyone can afford to visit the park. In addition, the park also clearly feels the effects of human activity. Industrial, commercial and residential areas, which are not compatible with the purpose of the park cause considerable damage. One of the most serious problems is the landfill in the bordering area.",
        weblink: "Weiterführender Link",
        image: "<img src=' parque_nacional.jpeg' />", 
    ...
    },
{
	  nr: 11,
        ...
        weblink: "Weiterführender Link",
        image: "<img src=' jardim_botânico.jpeg' />", 
