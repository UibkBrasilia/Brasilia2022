...
for (let entry of GRUPPE1) {
    ...
    mrk.bindPopup(`<h1>${entry.user}<h1>
        <h4>${entry.image}</h4>
        <h4>${entry.about}</h4>
        <p><a href="/Groups/Group1/group1.html" target="_blank"><i class="fas fa-external-link-alt mr-3" style="margin-right: 0.3em"></i> Link: Urban Living</a></p>
        <p>${entry.zoompic}</p>
        `, {
        maxHeight: 500,
        minWidth: 500,
...
for (let entry of GRUPPE2) {
    ...
    mrk.bindPopup(`<h1>${entry.user}<h1>
        <h4>${entry.about}</h4>
        <h4>${entry.image}</h4>
        <p><a href="/Groups/Group2/group2.html" target="_blank"><i class="fas fa-external-link-alt mr-3" style="margin-right: 0.3em"></i> Link: Leisure & Open Space</a></p>
        `, {
        maxHeight: 500,
        minWidth: 450,
        maxWidth: 500,
...
for (let entry of GRUPPE3) {
    ...
    mrk.bindPopup(`<h1>${entry.user}<h1>
        ...
        <h4>${entry.about}</h4>
        <h4>${entry.image}</h4>
        <p><a href="/Groups/Group3/group3.html" target="_blank"><i class="fas fa-external-link-alt mr-3" style="margin-right: 0.3em"></i> Link: Daily Life in Águas Claras</a></p>
        <p>${entry.zoompic}</p>
        `, {
        maxHeight: 500,
        minWidth: 250,
...
for (let entry of GRUPPE4) {
    ...
    mrk.bindPopup(`<h1>${entry.user}<h1>
        <h4>${entry.about}</h4>
        <h4>${entry.image}</h4>
        <p><a href="/Groups/Group4/group4.html" target="_blank"><i class="fas fa-external-link-alt mr-3" style="margin-right: 0.3em"></i> Link: Daily Life in Plano Piloto</a></p>
        `, {
        maxHeight: 500,
        minWidth: 250,
        maxWidth: 500,
...
for (let entry of GRUPPE5) {
    ...
    mrk.bindPopup(`<h1>${entry.user}<h1>
        ...
        <h4>${entry.about}</h4>
        <h4>${entry.image}</h4>
        <p><a href="/Groups/Group5/group5.html" target="_blank"><i class="fas fa-external-link-alt mr-3" style="margin-right: 0.3em"></i> Link: Mobility</a></p>
        `, {
        maxHeight: 500,
        minWidth: 250,
        maxWidth: 500,
